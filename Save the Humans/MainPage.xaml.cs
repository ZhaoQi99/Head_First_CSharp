...
namespace Save_the_Humans
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        /// 从导航缓存中放弃此页。值必须符合
        /// <see cref="Common.SuspensionManager.SessionState"/> 的要求。
        /// </summary>
        /// <param name="sender">事件的源；通常 <see cref="Common.NavigationHelper"/></param>
        ...
        private void playArea_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            if(humanCaptured)
            {
                Point pointPosition = e.GetCurrentPoint(null).Position;
                Point relativePosition = grid.TransformToVisual(playArea).TransformPoint(pointPosition);
